...
const AdminAssistant = (() => {
  ...
  function buildSystemPrompt() {
    ...
    // Confidence thresholds (controllable from ProtoGuide settings)
    const thresholds = window._confidenceThresholds || {};
    const _ct = {
...
- Do not volunteer implementation caveats like "this is a prototype limitation" or direct the user to ProtoGuide.
- If something is unavailable, say so in normal product language and focus on the best next answer or action.
- ProtoGuide is the only surface that should explicitly discuss prototype framing.
</product_framing>
